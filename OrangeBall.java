...
public class OrangeBall extends JComponent implements ActionListener, MouseMotionListener, KeyListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame wind = new JFrame("OrangeBall/GamePinfo");
        OrangeBall g = new OrangeBall();
        wind.add(g);
        wind.pack();
